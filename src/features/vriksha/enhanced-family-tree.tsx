...
// Minimum readable scale — never auto-fit below this
...
export function EnhancedFamilyTree({
  ...
  const computeFitScale = useCallback(() => {
    ...
    const fitW = availW / (treeLayout.bounds.width + 60);
    const fitH = availH / (treeLayout.bounds.height + 60);
    const fit = Math.min(fitW, fitH);
    // Clamp: never go below MIN_FIT_SCALE (keeps nodes readable on mobile)
    return Math.max(MIN_FIT_SCALE, Math.min(fit, 1.2));
  }, [treeLayout.bounds]);
      ...
      <View style={[styles.emptyContainer, { paddingTop: insets.top }]}>
        ...
        >
          ...
          <View style={styles.emptyIconOuter}>
            <LinearGradient
              colors={[VanshColors.suvarna[100], VanshColors.suvarna[50]]}
          ...
          <Text style={styles.emptyLabel}>वंश वृक्ष</Text>
          <Text style={styles.emptyTitle}>Plant Your Family Tree</Text>
          <Text style={styles.emptyDescription}>
            Every mighty banyan starts from a single seed. Add yourself to begin weaving your family&apos;s story.
          </Text>
          
          <View style={styles.emptyActions}>
            <Pressable style={styles.primaryButton} onPress={handleAddMember}>
              <LinearGradient
                colors={[VanshColors.suvarna[500], VanshColors.suvarna[700]]}
                start={{ x: 0, y: 0 }}
                end={{ x: 1, y: 1 }}
    ...
    <GestureHandlerRootView style={styles.container}>
      ...
      >
        <Pressable style={styles.controlButton} onPress={() => {
          ...
          <MaterialIcons name="add" size={20} color={VanshColors.masi[700]} />
        </Pressable>
        ...
        <Pressable style={styles.controlButton} onPress={() => {
          ...
          <MaterialIcons name="remove" size={20} color={VanshColors.masi[700]} />
        </Pressable>
        
        <View style={styles.controlDivider} />
        
        <Pressable style={styles.controlButton} onPress={handleResetView}>
          <MaterialIcons name="center-focus-strong" size={18} color={VanshColors.suvarna[600]} />
        </Pressable>
        ...
        >
          <MaterialIcons name="info-outline" size={18} color={showLegend ? '#FFF' : VanshColors.masi[500]} />
        </Pressable>
        ...
        >
          <MaterialIcons name="people" size={16} color={VanshColors.suvarna[600]} />
        </Pressable>
      </Animated.View>
      ...
      {showLegend && (
        ...
        >
          ...
          <View style={styles.legendItem}>
            <View style={[styles.legendDot, { backgroundColor: VanshColors.neelam[500] }]} />
            <Text style={styles.legendText}>Male</Text>
          </View>
          <View style={styles.legendItem}>
            <View style={[styles.legendDot, { backgroundColor: VanshColors.padma[400] }]} />
            <Text style={styles.legendText}>Female</Text>
          </View>
          <View style={styles.legendItem}>
            <View style={[styles.legendDot, { backgroundColor: VanshColors.masi[400] }]} />
            <Text style={styles.legendText}>Deceased</Text>
          </View>
          <View style={styles.legendDivider} />
          <View style={styles.legendItem}>
            <View style={[styles.legendLine, { backgroundColor: VanshColors.padma[400] }]} />
            <Text style={styles.legendText}>Married</Text>
          </View>
          <View style={styles.legendItem}>
            <View style={[styles.legendLine, { backgroundColor: VanshColors.neelam[400] }]} />
      ...
      {currentRootMember && (
        ...
        >
          <View style={styles.viewingAsDot} />
          <Text style={styles.viewingAsText} numberOfLines={1}>
            {currentRootMember.firstName}&apos;s view
          </Text>
          <Pressable
            onPress={() => {
              Haptics.impactAsync(Haptics.ImpactFeedbackStyle.Light);
            ...
            hitSlop={8}
            style={styles.viewingAsSwitch}
          >
            <MaterialIcons name="swap-horiz" size={14} color={VanshColors.suvarna[600]} />
          </Pressable>
        </Animated.View>
      )}
      ...
      {firstSelectedId && secondSelectedId && relationshipLabel && (() => {
        ...
        return (
          ...
          >
            <LinearGradient
              colors={[VanshColors.suvarna[50], '#FFF']}
              style={styles.relationshipBadgeInner}
            >
      ...
      >
        <View style={styles.instructionsPill}>
          <MaterialIcons name="touch-app" size={12} color={VanshColors.suvarna[500]} />
          <Text style={styles.instructionsText}>
            Tap two members to see their relationship · Double tap to reset
          </Text>
        </View>
      </Animated.View>
...
const styles = StyleSheet.create({
  ...
  fabButton: {
    borderRadius: 30,
    shadowColor: VanshColors.suvarna[700],
